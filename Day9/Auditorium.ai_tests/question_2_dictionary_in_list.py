...
# Dictionaries. Your job is to create a function that can add new countries to this list.
#
# Write a function that will work with the following line of code on line 21 to add the entry for Brazil to the travel_
# log.
#
...
def add_new_country(country_visited, num_of_visits, cities):
    travel_log.append({"country": country_visited, "visits": num_of_visits, "cities": cities})
