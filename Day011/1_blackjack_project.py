...
def calculate_score(cards):
    ...
    if card_total == 21 and len(cards) == 2:
        return 0
    elif 11 in cards and card_total > 21:
        cards.remove(11)
        cards.append(1)
        return sum(cards)
    else:
...
def compare(user_score, computer_score):
    if (user_score > computer_score and user_score <= 21) or user_score == 0 or computer_score > 21:
        print("You win!")
    elif (computer_score > user_score and computer_score <= 21) or computer_score == 0 or user_score > 21:
        print("You lose.")
    else:
        print("Its a draw.")
...
def play_game():
    ...
    while not is_game_over:
        ...
        if user_score == 0 or computer_score == 0 or user_score > 21:
            ...
            another_draw = input("Would you like to draw another card? 'y' for yes, 'n' for no: ").lower()
            if another_draw == "y":
                user_cards.append(deal_card())
